...
<footer><div class="container footer-grid"><div><a class="brand footer-brand" href="index.html"><span class="brand-mark">K</span><span><strong>Khairpur</strong><small>Date Palm & Nursery</small></span></a><p>Authentic date palms, date products and evidence-backed service information.</p></div><div><h3>Products</h3><a href="date-palms.html">Date palms</a><a href="date-products.html">Date products</a><a href="wholesale-export.html">Wholesale</a></div><div><h3>Services</h3><a href="palm-supply-delivery.html">Supply & delivery</a><a href="palm-installation.html">Installation</a><a href="projects.html">Projects</a></div><div><h3>Contact</h3><a href="tel:+${business.phoneIntl}">${business.phone}</a><a href="mailto:${business.email}">${business.email}</a><a href="${whatsapp}" target="_blank" rel="noopener">WhatsApp us</a><a href="${business.facebook}" target="_blank" rel="noopener">Facebook ↗</a><span>${business.location}</span></div></div><div class="container footer-bottom"><span>© ${new Date().getFullYear()} ${business.name}</span><span>Rooted in Khairpur. Growing across Pakistan.</span></div></footer>
<div class="floating-actions"><a class="floating-fb" href="${business.facebook}" target="_blank" rel="noopener" aria-label="Visit our Facebook page">f</a><a class="floating-wa" href="${whatsapp}" target="_blank" rel="noopener" aria-label="Start WhatsApp enquiry">◉ <span>WhatsApp enquiry</span></a></div><nav class="mobile-conversion" aria-label="Quick contact"><a href="tel:+${business.phoneIntl}"><span>Call us</span><strong>${business.phone}</strong></a><a href="${whatsapp}" target="_blank" rel="noopener"><span>WhatsApp</span><strong>Start enquiry</strong></a></nav><script src="script.js"></script>${page.mediaCategory ? '<script src="supabase-config.js"></script><script src="media-gallery.js"></script>' : ''}<script src="assistant.js"></script></body></html>`;
}
